...
unsigned int numSensors = 7;      // Enter number of sensors as 5 or 7 based on your IR array
bool brakeEnabled = 0;
...
void loop() {
  ...
  while (1) {
    ...
    if (onLine == 1) {  //PID LINE FOLLOW
      ...
      brakeFlag = 0;
      if (sensorValue[0] > 800 && sensorValue[1] > 800 && sensorValue[2] > 800 && sensorValue[3] > 800 && sensorValue[4] > 800 && sensorValue[5] > 800 && sensorValue[6] > 800 ) 
      {
        ...
        if (onLine == 1) {
          if (sensorValue[0] > 800 && sensorValue[1] > 800 && sensorValue[2] > 800 && sensorValue[3] > 800 && sensorValue[4] > 800 && sensorValue[5] > 800 && sensorValue[6] > 800 ) 
          {
              // Black square detected, stopping...
            ...
            motor1.drive(0);
            motor2.drive(0);
            break; // Exit loop if black square is detected
          }  
          else {
            linefollow();
          }
